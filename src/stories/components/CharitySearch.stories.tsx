...
export default {
  title: "Components/CharitySearch",
  component: CharitySearch,
  tags: ["autodocs"],
} as Meta<typeof CharitySearch>;

const categories: CharityCategoryData[] = Array.from({ length: 3 }).map(() => {
  return {
    ID: 1,
...
const Template: StoryFn<typeof CharitySearch> = () => (
  <CharitySearch categories={categories} />
);
